...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Maio-2022 às 19:00
...
--
-- Banco de dados: `vendas_izabelle`
--
...
INSERT INTO `produtos` (`id`, `nome`, `preco`, `quantidade`, `descricao`, `fabricantes_id`) VALUES
(1, 'TV LED', '2000.00', 5, 'TV de última geração', 5),
(2, 'Iphone XYZ', '1000.99', 11, 'Smartphone caro para caramba e sem bateria', 3),
